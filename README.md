...
| **Rows with seller-published weight** | 256 | Explicit metal weight; the other 223 show "—" (no weight is invented) |
...
| **Men's/unisex rows below $6,000 / pure-gold-oz (user threshold session 9, 2026-08-28; ≈ melt +34%)** | **9** | Same 9 as at $5,500: 3 Midwest men's 14K mountings ($3,794 / $3,864 / $4,190) + the ¼ oz .9999 Nebü bullion-ring family verified live 2026-08-28: Tex Metals ×2 ($4,996.95 / $4,999.40, in stock), SD Bullion ×2 ($5,278.71 / $5,283.80, OOS), JM Bullion ×2 ($5,370.84, ACH tier). Raising the line $5,500→$6,000 admitted **nothing**: the only rows in the new window are BGASC's quarantined stale-feed Crossover ($5,529.72) and 7879's ladies' Size-4 stacker ($5,742.61). Nearest misses: SD thread $6,174.21 (+2.9%), SD Olive Branch $6,177.68, Provident Mens Curved $6,182.95 (captcha-held). Links per row: [`docs/REVIEW_2026-08-28.md`](docs/REVIEW_2026-08-28.md) §3 + §10. |
